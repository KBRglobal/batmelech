...
export const LOCAL_ICON_PATHS = {
  ...
  'ph:identification-card-bold': `${PUBLIC_BASE}icons/ph-identification-card-bold.svg`,
  ...
  'ph:prohibit-bold': `${PUBLIC_BASE}icons/ph-prohibit-bold.svg`,
  'ph:question-bold': `${PUBLIC_BASE}icons/ph-question-bold.svg`,
  ...
  'ph:user-bold': `${PUBLIC_BASE}icons/ph-user-bold.svg`,
