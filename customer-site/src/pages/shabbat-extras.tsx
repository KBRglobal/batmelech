...
const HE = {
  ...
  coupleSubtitle: 'חבילה שלמה הכוללת מארז 12 סלטים, מנה ראשונה, עיקרית, תוספת וקינוח. המשלוח בדובאי כלול במחיר.',
...
export const COPY: Record<Locale, typeof HE> = {
  ...
  en: {
    ...
    coupleSubtitle: 'A complete package: the box of 12 salads, a first course, a main, a side, and dessert. Delivery in Dubai is included in the price.',
  ...
  fr: {
    ...
    coupleSubtitle: 'Une formule complète : le coffret de 12 salades, une entrée, un plat, un accompagnement et un dessert. La livraison à Dubaï est incluse dans le prix.',
