...
const HE = {
  ...
  intro: {
    title: 'המחויבות שלנו',
    body:
      'מטעמי בת מלך מבקשים שכל אחד יוכל לקרוא את התפריט ולהזמין ארוחה, גם עם מוגבלות. האתר נבנה לפי הנחיות הנגישות לתוכן באינטרנט, ‏WCAG 2.1 ברמה AA, ואנחנו ממשיכים לשפר אותו.',
  },
  done: {
    title: 'מה נעשה באתר',
    items: [
...
export const COPY: Record<Locale, typeof HE> = {
  ...
  en: {
    ...
    intro: {
      ...
      body:
        'Bat Melech wants everyone to be able to read the menu and order a meal, disability included. This site is built to the Web Content Accessibility Guidelines, WCAG 2.1 level AA, and we keep improving it.',
    },
    done: {
  ...
  fr: {
    ...
    intro: {
      ...
      body:
        'Bat Melech souhaite que chacun puisse lire le menu et commander un repas, handicap compris. Ce site est conçu selon les règles pour l’accessibilité des contenus web, WCAG 2.1 niveau AA, et nous continuons de l’améliorer.',
    },
    done: {
