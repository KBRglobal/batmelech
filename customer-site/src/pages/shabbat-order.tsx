...
const HE = {
  ...
  saladsHint: 'כל 12 הסלטים מגיעים עם כל חבילה זוגית, בלי צורך לבחור. המארז כלול בכל ארוחה זוגית. מארז נוסף, או מארז בלי ארוחה זוגית — 60$ (בעמוד החיזוקים).',
...
export const COPY: Record<Locale, typeof HE> = {
  ...
  en: {
    ...
    saladsHint: 'All 12 salads come with every box for two. Nothing to choose. The box is included with every package for two. An additional box, or a box on its own, is $60 (on the Weekend Boosters page).',
  ...
  fr: {
    ...
    saladsHint: 'Les 12 salades accompagnent chaque coffret pour deux. Rien à choisir. Le coffret est inclus dans chaque formule pour deux. Un coffret supplémentaire, ou un coffret seul, coûte 60 $ (sur la page des extras du week-end).',
    firstsTitle: 'Entrées',
