      ...
      <main className="pt-32 max-w-7xl mx-auto px-6">
        <section className="mb-20 text-center max-w-4xl mx-auto space-y-6">
          ...
          <h1 className="text-5xl md:text-8xl font-black font-heading leading-none">
            חוויות קולינריות <br />
            <span className="text-[#8D182C]">VIP בדובאי</span>
          </h1>
          <p className="text-xl md:text-2xl font-bold text-[#3B151A]/70 leading-relaxed mt-8">
            אנחנו מביאים את השף ואת האוכל הכי טוב בדובאי – בדיוק לאן שאתם נמצאים. גלו את מגוון האפשרויות שלנו
            לאירועים פרטיים ויוקרתיים.
          </p>
        </section>
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-32">
          ...
          <div className="bg-[#3B151A] rounded-[4rem] p-10 flex flex-col items-center justify-center text-center border-4 border-[#F5A83A]/30 shadow-2xl">
