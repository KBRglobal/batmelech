        ...
        <Reveal>
          <section className="bg-[#8D182C] p-12 md:p-24 rounded-[5rem] text-center shadow-2xl">
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-4xl md:text-6xl font-black text-white mb-8 font-heading leading-tight">{t.planTitle}</h2>
              <p className="text-white/80 text-xl font-bold mb-12 leading-relaxed">{t.planBody}</p>
              <a
                href="https://wa.me/971586288776"
              ...
              >
                {t.planCta} <Icon icon="ph:whatsapp-logo-fill" className="text-4xl text-[#25D366]" />
              </a>
            </div>
          </section>
        </Reveal>
