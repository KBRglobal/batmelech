...
const SYSTEM_PROMPT = [
  ...
  'Dates on these invoices are printed month-first (MM-DD-YYYY hh:mm:ss). Never emit a purchase date later than today; if a reading lands in the future, the day and month were swapped — flip them.',
